...
The longer comments from `synthComms.c`, moved here 2026-09-12 so the code reads cleanly. The code points at each as `// notes §k`. Verbatim and in file order; each is titled by what it documents.
...
## 10. `decode_signed_param_wire_value()`
...
## 11. `encode_signed_param_wire_value()`
...
## 18. `synth_apply_korg_prog_dump_locally()`
...
## 21. `synth_encode_dump_raw_value()`
...
## 22. in `synth_encode_dump_raw_value()`
...
## 24. `synth_moog_single_preset_dump_intact()`
...
## 34. `synth_decode_korg_prog_dump()`
...
## 39. `synth_patch_moog_dump_cache()`
...
## 40. `synth_apply_pending_dump_patches()`
...
## 41. in `synth_apply_pending_dump_patches()`
...
## 43. `synth_apply_moog_panel_dump_locally()`
...
## 44. `handle_moog_single_preset_dump()`
...
## 45. in `handle_moog_single_preset_dump()`
...
## 46. in `handle_moog_single_preset_dump()`
...
## 47. in `handle_moog_single_preset_dump()`
...
## 48. `handle_moog_all_presets_dump()`
...
## 54. `synth_request_kronos_current_object_dump()`
...
## 55. `synth_send_kronos_parameter_change()`
...
## 56. in `synth_request_state_dump()`
...
## 57. in `synth_request_state_dump()`
...
## 58. in `synth_request_single_preset_dump()`
...
## 59. in `synth_request_all_presets_dump()`
...
## 63. in `synth_load_patch_from_bank()`
...
## 64. in `synth_korg_select_program()`
...
## 65. in `synth_send_korg_program_write_request()`
...
## 66. `synth_send_korg_current_program_dump()`
...
## 67. `synth_send_korg_program_data_dump()`
...
## 73. `synth_flush_pending_dump_sends()`
...
## 74. `handle_kronos_parameter_change()`
...
## 79. in `synth_set_panel_dial_value()`
...
## 80. in `synth_set_panel_dial_value()`
...
## 81. in `synth_set_panel_dial_value()`
...
## 82. in `synth_set_panel_dial_value()`
...
## 83. in `synth_set_panel_dial_value()`
...
## 84. in `synth_set_panel_dial_value()`
