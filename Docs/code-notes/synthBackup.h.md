...
The longer comments from `synthBackup.h`, moved here 2026-09-12 so the code reads cleanly. The code points at each as `// notes §k`. Verbatim and in file order; each is titled by what it documents.
...
## 5. `synth_backup_patch_by_number()`
...
## 6. `synth_backup_patch_by_number_korg()`
...
## 9. `synth_backup_flush_bank_to_folder()`
...
## 10. `synth_backup_flush_korg_name_sweep()`
...
## 11. `synth_backup_sweep_request_in_flight()`
...
## 12. `synth_backup_flush_background_prefetch()`
...
## 14. in `synth_backup_capture_dump()`
...
## 15. `synth_backup_restore_edit_buffer()`
...
## 16. `synth_backup_restore_edit_buffer_from_path()`
...
## 18. `synth_backup_restore_patch_to_bank()`
...
## 19. `synth_backup_restore_patch_to_bank_from_path()`
...
## 21. `synth_backup_restore_folder()`
...
## 22. `synth_backup_flush_restore_folder()`
...
## 23. `synth_backup_flush_korg_restore_folder()`
...
## 25. `synth_backup_start_name_sweep()`
...
## 26. `synth_backup_note_preset_name()`
...
## 27. `synth_backup_reload_name_cache_for_device()`
...
## 28. `synth_backup_clear_name_cache_for_device()`
...
## 29. in `synth_backup_clear_name_cache_for_device()`
...
## 32. `synth_backup_flush_pending_save()`
...
## 33. `synth_backup_get_export_progress()`
...
## 34. `synth_backup_export_progress_is_name_sweep()`
