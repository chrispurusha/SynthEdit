...
- Adopt GenBridge's audio/MIDI selector: SynthEdit has NO device UI at all, only layouts' midiPort name matching, which is what made today's unpowered Thru box hard to place - see GenBridge findings 2026-09-02
